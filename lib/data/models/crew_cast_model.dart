class CrewAndCastModel {
  ...
  factory CrewAndCastModel.fromJson(Map<String, dynamic> json) => CrewAndCastModel(
    id: json["id"],
...
enum Department { ACTING, CREW, EDITING, PRODUCTION, COSTUME_MAKE_UP, DIRECTING, SOUND, WRITING, CAMERA, ART }
